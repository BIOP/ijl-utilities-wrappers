...
@Plugin(type = Command.class, menuPath = "Plugins>BIOP>StarDist>StarDist3D Adv. ...")
public class StarDist3D_Advanced extends StarDistAbstractCommand implements Command{
    @Parameter
    int x_tiles=-1;
